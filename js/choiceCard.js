    ...
    for (var i = 0; i < liList.length; i++) {
        ...
        (function () {
            ...
            cur.onmouseenter = function () {
                ...
                //if (cur.index === current) {
                //    utils.setCss(liList[current], "color", "#fff");
                //    var oAs = liList[current].getElementsByTagName("a");
                //    for (var k = 0; k < oAs.length; k++) {
                //        utils.setCss(oAs[k], "color", "#fff");
                //    }
                //}
            };
        ...
        details.onmouseleave = function () {
            ...
            //utils.setCss(liList[current], "color", "#000");
            //var oAs = liList[current].getElementsByTagName("a");
            //for (var k = 0; k < oAs.length; k++) {
            //    utils.setCss(oAs[k], "color", "#000");
            //}
        }
    }
